...
namespace Ecommerce121\UtilBundle\Doctrine\Query;
...
class ResultSetMappingBuilder extends DoctrineResultSetMappingBuilder
{
     ...
     */
    public function __construct(EntityManagerInterface $em, $defaultRenameMode = DoctrineResultSetMappingBuilder::COLUMN_RENAMING_NONE)
    {
