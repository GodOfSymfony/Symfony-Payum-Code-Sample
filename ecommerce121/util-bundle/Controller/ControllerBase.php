...
use Ecommerce121\UtilBundle\Http\JsonResponse;
...
class ControllerBase
{
     ...
     * @param object|null $event     The event object to be dispatched
     */
    protected function dispatchEvent($eventName, $event = null)
    {
        $this->controllerUtil->getEventDispatcher()->dispatch($event, $eventName = null);
    }
